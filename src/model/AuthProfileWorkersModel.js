...
const getUserByEmail = async (email) => {
    ...
    return new Promise((resolve, reject) =>
        Pool.query(`SELECT * FROM workers_authprofile WHERE email='${email}'`, (err, result) => {
            if (err) {
                reject(err);
            } else {
                resolve(result);
...
const activatedUser = async (uuid) => {
    ...
    return new Promise((resolve, reject) =>
        Pool.query(`UPDATE workers_authprofile SET is_active=true WHERE checker='${uuid}'`, (err, result) => {
            if (!err) {
                resolve(result);
            } else {
                reject(err);
...
const changePassword = async (email, data) => {
    ...
    return new Promise((resolve, reject) =>
        Pool.query(`UPDATE workers_authprofile SET username='${username}',password='${password}' WHERE workers_authprofile.email= '${email}'`, (err, result) => {
            if (err) {
                reject(err);
            } else {
                resolve(result);
...
const getAuthProfileWorkersById = (id) => {
    return new Promise((resolve, reject) => {
        Pool.query(`SELECT * FROM workers_authprofile WHERE id=${id}`, (err, result) => {
            if (err) {
                reject(err);
            } else {
                resolve(result);
