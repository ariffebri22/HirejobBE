...
const getUsersByEmail = async (email) => {
    ...
    return new Promise((resolve, reject) =>
        Pool.query(`SELECT * FROM company_authprofil WHERE email='${email}'`, (err, result) => {
            if (!err) {
                resolve(result);
            } else {
                reject(err);
...
const activatedUser = async (uuid) => {
    ...
    return new Promise((resolve, reject) =>
        Pool.query(`UPDATE company_authprofil SET is_active=true WHERE checker='${uuid}'`, (err, result) => {
            if (!err) {
                resolve(result);
            } else {
                reject(err);
...
const changeData = async (email, data) => {
    ...
    return new Promise((resolve, reject) =>
        Pool.query(`UPDATE company_authprofil SET password='${password}' WHERE company_authprofil.email='${email}'`, (err, result) => {
            if (err) {
                reject(err);
            } else {
                resolve(result);
...
const getAuthProfileRecruiterById = (id) => {
    return new Promise((resolve, reject) => {
        Pool.query(`SELECT * FROM company_authprofil WHERE id=${id}`, (err, result) => {
            if (err) {
                reject(err);
            } else {
                resolve(result);
