...
const getExpCount = async (data) => {
  ...
  return new Promise((resolve, reject) =>
    Pool.query(
      `SELECT COUNT(*) FROM workers_experience WHERE ${searchBy} ILIKE '%${search}%'`,
      (err, result) => {
        if (!err) {
          resolve(result);
        } else {
...
const getExpByIdWorkers = async (id) => {
  ...
  return new Promise((resolve, reject) =>
    Pool.query(
      `SELECT * FROM workers_experience WHERE id_workers=${id}`,
      (err, result) => {
        if (!err) {
          resolve(result);
        } else {
...
const getExpById = async (id) => {
  ...
  return new Promise((resolve, reject) =>
    Pool.query(
      `SELECT * FROM workers_experience WHERE id=${id}`,
      (err, result) => {
        if (!err) {
          resolve(result);
        } else {
...
const deleteExpById = async (id) => {
  ...
  return new Promise((resolve, reject) =>
    Pool.query(
      `DELETE FROM workers_experience WHERE id=${id}`,
      (err, result) => {
        if (!err) {
          resolve(result);
        } else {
