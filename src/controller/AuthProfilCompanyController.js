...
const ProfilRecruiterController = {
    ...
    putRecruiter: async (req, res, next) => {
        const { id } = req.params;
        const { perusahaan, bidang, provinsi, kota, deskripsi, email_perusahaan, phone_company, linkedin } = req.body;
        const { photo } = req.file;
        console.log("req.body");
        console.log(req.body);
        console.log(perusahaan, bidang, provinsi, kota, deskripsi, email_perusahaan, phone_company, linkedin, photo);
        ...
        let data = {
            perusahaan: perusahaan || dataRecruiterId.rows[0].perusahaan,
