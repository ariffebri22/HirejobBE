const { postSkillWorkers, getSkillWorkersById, putSkillWorkers } = require("../model/SkillWorkersModel");
...
const skillWorkersController = {
    postWorkers: async (req, res, next) => {
        ...
        console.log(id_worker, skills_name);

        if (!id_worker || !skills_name) {
        ...
        let result = await postSkillWorkers(data);
        console.log(result);
...
module.exports = skillWorkersController;
