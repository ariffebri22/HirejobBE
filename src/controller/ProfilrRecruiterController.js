const {getRecruiterAll,postCompany } = require('../model/ProfilRecruiterModel')
const argon2 = require('argon2');
// const { GenerateToken } = require('./../helpers/GenerateToken');
const cloudinary = require('../config/photo')

const ProfilrRecruiterController = {
...
//         }
//     },
    postDataCompany: async (req, res, next) => {
        const { bidang, provinsi,kota,deskripsi,email_perusahaan,phone_company,linkedin} = req.body
        console.log("post data ")
        console.log(bidang, provinsi,kota,deskripsi,email_perusahaan,phone_company,linkedin)
...
module.exports = ProfilrRecruiterController